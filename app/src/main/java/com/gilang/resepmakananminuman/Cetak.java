...
public class Cetak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPrint = findViewById(R.id.cetak);
    ...
    private void takeScreenShot(){
        ...
        View u = findViewById(R.id.resepmakanan);

        NestedScrollView z = findViewById(R.id.resepmakanan);
        totalHeight = z.getChildAt(0).getHeight();
        totalWidth = z.getChildAt(0).getWidth();

        String extr = Environment.getExternalStorageDirectory() + "/Resep Makanan/";
